...
- Submissions are now loaded in one go, instead of iterating over all students.

### Fixed

- Fix loading submissions when not all students were assigned the assignment.

## [1.7.1] - 2025-12-04

### Fixed

- Escape _all_ paths and leave out `__init__.py` when opening VS Code.
